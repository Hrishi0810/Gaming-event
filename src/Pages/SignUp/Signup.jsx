        ...
        <Box id={style.signup_main}>
            ...
            <div id={style.mainnn}>
                <Box id={style.signup_form}>
                    <FormControl>
                        <FormLabel fontSize='30px' color='orangered' fontWeight="500">Name*</FormLabel>
                        ...
                        <FormLabel fontSize='30px' color='orangered' fontWeight="500" >Email*</FormLabel>
                        ...
                        <FormLabel fontSize='30px' color='orangered' fontWeight="500">Password*</FormLabel>
                        <Input fontSize='30px' fontWeight="600" name='password' color="#718096" value={formData.password} onChange={HandleChange} type="password" placeholder='Enter your Password' />
                        <FormLabel fontSize='30px' color='orangered' fontWeight="500">Confirm Password*</FormLabel>
